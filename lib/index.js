...
RpcClient.callspec = {
  ...
  omni_listtransactions: 'str',
  omni_listtransactions: '',
  omni_getbalance: 'str int',
  omni_getallbalancesforaddress: 'str',
  omni_gettransaction: 'str',
  omni_send: 'str str int str',
  omni_getwalletbalances: '',
  omni_getwalletaddressbalances: '',
  omni_listpendingtransactions: 'str',
  omni_sendall: 'str str int',
  validateaddress: 'str',
  omni_funded_send: 'str str int str str',
  omni_funded_sendall: 'str str int str',
};
